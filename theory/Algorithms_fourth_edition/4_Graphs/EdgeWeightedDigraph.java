 ...
 *  It also provides methods for returning the number of vertices V and the number
...
public class EdgeWeightedDigraph {
    ...
    private int[] indegree;    // indegree[v] = inegree of vertex v
    ...
    // Unit test the EdgeWeightedDigraph data type.
