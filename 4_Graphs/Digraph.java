...
public class Digraph {
    ...
    // The format is the number of vertices V, followed by the
    // number of edges E, followed by E pairs of vertices, with
    ...
    public void addEdgeWithoutParallelAndLoops(int v, int w) {
        if (v == w)
    ...
    // Add a method hasEdge() to Digraph which takes two int arguments 
    // v and w and returns true if the graph has an edge v->w, false otherwise.
    ...
    // Retruns the number of directed edges incident to vertex v.
