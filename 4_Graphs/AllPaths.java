...
// between two specified vertices. Hint: use DFS and backtracking. Warning: there many be exponentially 
// many simple paths in a graph, so no algorithm can run efficiently for large graphs.
...
public class AllPaths {
    ...
    private void dfs(Graph G, int v, int t) {
        ...
        // done wxploring from v, so remove from path
        path.pop();
        onPath[v] = false;
    }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println();
        StdOut.println("all simple paths between 0 and 2:");
        AllPaths allpaths1 = new AllPaths(G, 0, 2);
