...
// equals() method to test whether two keys are equal. It does not call either the compareTo()
// or hashCode() method.
// The put and delete operations take linear time; the get and contains operations takes liner
...
public class SequentialSearchST<Key, Value> {
    ...
    // a helper linked list data tyep
    private class Node {
        private Key key;
        private Value val;
        private Node next;
    ...
    // this symbol value if the specified value is null.
